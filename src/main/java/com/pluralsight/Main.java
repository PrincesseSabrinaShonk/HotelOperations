...
public class Main {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee(1, "Samuel", "It", 25, 10);
        Employee emp2 = new Employee(1, "Sabrina", "Nato", 50, 0);
        Employee emp3 = new Employee(1, "Kina", "Engineer", 35, 40);
        Employee emp4 = new Employee(1, "Ayah", "Coder", 50, 41);
